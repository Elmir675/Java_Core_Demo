...
public class DecimalDemo {
    public static void main(String[] args) {
         ...
         */
        float floatNumber = (float) 10.3;//LOŠIJI NAČIN
        float floatNumber3 = 10.3F;//BOLJI NAČIN

        double doubleNumber = 10.3;

        /**
         * Nikada nemojte koristiti double i float zua finansijske ili neke proračune
